...
export default class Main {
	...
	create() {
		...
		this.player = new Player(this.game, this.layerPlayer);

		this.waveManager = new WaveManager(this.game, this.player, this.layerMonsters, this.spawners);
		this.waveManager.start();

		this.hud = new Hud(this.game, this.player, this.waveManager);
	...
	hitWall(attacker, target) {
		attacker.kill();
	}

	walkingOnLava(player, lavaTile) {
...
SaveManager.saveHighscore(data);
